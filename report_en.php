<?php
/**
 * VPN Stats Collector - FINAL VERSION (EN)
 */
...
switch ($reportType) {
    case 'weekly':
        ...
        $dateLabel = "Week " . date('W/Y', strtotime($reportDate)) . " (" . date('d.m', strtotime($startDate)) . " - " . date('d.m.Y', strtotime($endDate)) . ")";
        break;
...
<body>
    <div class="container">
        <h1>📊 VPN Operations Report - <?php echo $dateLabel; ?></h1>
        ...
        <div class="filter-form">
            <form method="GET" action="">
                ...
                <button type="button" onclick="window.location.href='?date=<?php echo date('Y-m-d'); ?>&type=daily'">Today</button>
        ...
        <?php if (count($userStats) == 0): ?>
            <div style="padding: 40px; text-align: center; color: #7f8c8d;">
                ...
                <p>No VPN connections were recorded for this period.</p>
            </div>
        <?php else: ?>
        ...
        <div class="summary-cards">
            ...
            <div class="summary-card blue">
                ...
                <div class="label">Per connection</div>
            </div>
        </div>
        ...
        <div class="summary-cards">
            ...
            <div class="summary-card blue">
                ...
                <div class="label">To internal network</div>
            </div>
        ...
        <div class="chart-container">
            ...
            <div class="chart-bar">
                ...
                <div class="chart-bar-fill" style="width: <?php echo $width; ?>%;">
                    <?php echo $connections; ?> connections
                </div>
                <?php endif; ?>
            </div>
            <?php endfor; ?>
        ...
        <h2>⏱️ Top 5 longest sessions</h2>
        <table>
            <thead>
                <tr>
                    <th>User</th>
        ...
        <div class="footer">
            Generated: <?php echo date('d.m.Y H:i:s'); ?> | VPN Report v1.0 | (c) MILNET.cz | Martin Pouzar
        </div>
    </div>
</body>
</html>
